  ...
  return (
    ...
    <Navbar className="Nav">
      <Container className="navitems d-flex justify-content-center">
        ...
        <Nav.Item className="navstyle">
          <Link className="navbar-brand" to="/home">About Us</Link>
        </Nav.Item >
        <Nav.Item className='navstyle' >
        ...
        <Nav.Item className="navstyle">
          <Link className="navbar-brand" to="/home">Contact</Link>
        </Nav.Item>
        <Nav.Item className="navstyle">
          <Link className="navbar-brand" to="/home">Login/Register</Link>
        </Nav.Item>
        <Nav.Item className="navstyle">
          <Link className="navbar-brand" to="/home">Cart</Link>
        </Nav.Item>
        {/* </Nav> */}
      </Container>
    </Navbar>
